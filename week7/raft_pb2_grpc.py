...
class RaftNodeStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SetVal = channel.unary_unary(
                '/RaftNode/SetVal',
                request_serializer=raft__pb2.KeyValueArgs.SerializeToString,
                response_deserializer=raft__pb2.Result.FromString,
                )
        self.GetVal = channel.unary_unary(
                '/RaftNode/GetVal',
                request_serializer=raft__pb2.KeyArgs.SerializeToString,
                response_deserializer=raft__pb2.ResultWithValue.FromString,
                )
...
def add_RaftNodeServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SetVal': grpc.unary_unary_rpc_method_handler(
                    servicer.SetVal,
                    request_deserializer=raft__pb2.KeyValueArgs.FromString,
                    response_serializer=raft__pb2.Result.SerializeToString,
            ),
            'GetVal': grpc.unary_unary_rpc_method_handler(
                    servicer.GetVal,
                    request_deserializer=raft__pb2.KeyArgs.FromString,
                    response_serializer=raft__pb2.ResultWithValue.SerializeToString,
            ),
    }
...
class RaftNode(object):
    ...
    def SetVal(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/RaftNode/SetVal',
            raft__pb2.KeyValueArgs.SerializeToString,
            raft__pb2.Result.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetVal(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/RaftNode/GetVal',
            raft__pb2.KeyArgs.SerializeToString,
            raft__pb2.ResultWithValue.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
